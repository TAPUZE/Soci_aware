...
class EchoAnalyzer {
  // Web-compatible version without tflite_flutter
  ...
  Future<void> loadModel() async {
    // Web version doesn't load TensorFlow Lite model
    print('Web version: Model loading skipped (not supported on web)');
  }
